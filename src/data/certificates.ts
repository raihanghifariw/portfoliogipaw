...
export const CREDLY_BADGES: CredlyBadge[] = [
  ...
  },
  {
    ...
    badgeId: "ce70b3f5-7c8a-4521-b192-763a75bf18f8",
    title: "Build Global and Regional Load Balancing Solutions Skill Badge",
    issuer: "Google Cloud",
    issuerCode: "google",
    category: "cloud",
    categoryLabel: "CLOUD INFRASTRUCTURE",
    localImage: "https://images.credly.com/images/c9227642-035d-4276-8789-01438551114b/linkedin_thumb_blob",
    remoteImage: "https://images.credly.com/images/c9227642-035d-4276-8789-01438551114b/linkedin_thumb_blob",
    verificationUrl: "https://www.credly.com/badges/ce70b3f5-7c8a-4521-b192-763a75bf18f8",
    embedUrl: "https://www.credly.com/embedded_badge/ce70b3f5-7c8a-4521-b192-763a75bf18f8",
    description: "Configuring and managing global and regional load balancing architectures on Google Cloud for high availability, traffic distribution, and resilient web infrastructure.",
    skills: ["Cloud Load Balancing", "GCP Compute Engine", "Traffic Management", "High Availability", "Network Routing"],
    issueDate: "2025"
  },
  {
    id: "gcp-firebase-serverless",
    badgeId: "aa0aa42d-69fb-4453-b6b9-2d620db0cc83",
    title: "Develop Serverless Apps with Firebase Skill Badge",
    issuer: "Google Cloud",
    issuerCode: "google",
    category: "cloud",
    categoryLabel: "SERVERLESS & APP DEV",
    localImage: "https://images.credly.com/images/826e89a5-1a1d-4e6c-b740-531957965a78/linkedin_thumb_image.png",
    remoteImage: "https://images.credly.com/images/826e89a5-1a1d-4e6c-b740-531957965a78/linkedin_thumb_image.png",
    verificationUrl: "https://www.credly.com/badges/aa0aa42d-69fb-4453-b6b9-2d620db0cc83",
    embedUrl: "https://www.credly.com/embedded_badge/aa0aa42d-69fb-4453-b6b9-2d620db0cc83",
    description: "Building, deploying, and managing full-stack serverless web applications using Google Cloud Firebase, Cloud Functions, and Firestore databases.",
    skills: ["Firebase", "Serverless Architecture", "Cloud Functions", "Firestore", "Full-Stack Cloud"],
    issueDate: "2025"
  },
  {
    id: "gcp-looker-lookml",
    badgeId: "4dfcac9c-25b2-42bf-bf77-429e34888adf",
    title: "Build LookML Objects in Looker Skill Badge",
    issuer: "Google Cloud",
    issuerCode: "google",
    category: "data",
    categoryLabel: "BUSINESS INTELLIGENCE & BI",
    localImage: "https://images.credly.com/images/2607a61b-7f94-43d7-bb97-3e811312c53e/linkedin_thumb_image.png",
    remoteImage: "https://images.credly.com/images/2607a61b-7f94-43d7-bb97-3e811312c53e/linkedin_thumb_image.png",
    verificationUrl: "https://www.credly.com/badges/4dfcac9c-25b2-42bf-bf77-429e34888adf",
    embedUrl: "https://www.credly.com/embedded_badge/4dfcac9c-25b2-42bf-bf77-429e34888adf",
    description: "Creating curated data models, views, dimensions, measures, and joins with LookML to power enterprise Business Intelligence dashboards in Looker.",
    skills: ["Looker", "LookML", "Data Modeling", "Business Intelligence", "Analytics Dashboards"],
    issueDate: "2025"
  },
  {
    id: "gcp-kubernetes-deploy",
    badgeId: "0101a64d-5439-4af4-be78-2e6085330f34",
    title: "Deploy Kubernetes Applications on Google Cloud Skill Badge",
    issuer: "Google Cloud",
    issuerCode: "google",
    category: "cloud",
    categoryLabel: "KUBERNETES & CONTAINERS",
    localImage: "https://images.credly.com/images/f0388a0c-130f-47cd-8750-d6357e907e58/linkedin_thumb_image.png",
    remoteImage: "https://images.credly.com/images/f0388a0c-130f-47cd-8750-d6357e907e58/linkedin_thumb_image.png",
    verificationUrl: "https://www.credly.com/badges/0101a64d-5439-4af4-be78-2e6085330f34",
    embedUrl: "https://www.credly.com/embedded_badge/0101a64d-5439-4af4-be78-2e6085330f34",
    description: "Deploying, scaling, and managing containerized applications on Google Kubernetes Engine (GKE) with production best practices.",
    skills: ["Google Kubernetes Engine (GKE)", "Kubernetes", "Container Orchestration", "Microservices", "Docker"],
    issueDate: "2025"
  },
  {
    id: "gcp-genai-gemini-streamlit",
    badgeId: "711d38a0-cabd-4d16-a6c2-8648c2332e4a",
    title: "Develop GenAI Apps with Gemini and Streamlit Skill Badge",
    issuer: "Google Cloud",
    issuerCode: "google",
    category: "ai",
    categoryLabel: "GENERATIVE AI & LLMs",
    localImage: "https://images.credly.com/badges/711d38a0-cabd-4d16-a6c2-8648c2332e4a/image.png",
    remoteImage: "https://images.credly.com/badges/711d38a0-cabd-4d16-a6c2-8648c2332e4a/image.png",
    verificationUrl: "https://www.credly.com/badges/711d38a0-cabd-4d16-a6c2-8648c2332e4a",
    embedUrl: "https://www.credly.com/embedded_badge/711d38a0-cabd-4d16-a6c2-8648c2332e4a",
    description: "Building and deploying interactive generative AI applications using Gemini LLM models and Streamlit frontend frameworks on Google Cloud.",
    skills: ["Gemini API", "Streamlit", "Generative AI", "Prompt Engineering", "Python"],
    issueDate: "2025"
  },
  {
    id: "gcp-multimodal-rag-gemini",
    badgeId: "7cb543db-7b58-4711-8ac9-515e5b0caee2",
    title: "Inspect Rich Documents with Gemini Multimodality and Multimodal RAG Skill Badge",
    issuer: "Google Cloud",
    issuerCode: "google",
    category: "ai",
    categoryLabel: "MULTIMODAL AI & RAG",
    localImage: "https://images.credly.com/badges/7cb543db-7b58-4711-8ac9-515e5b0caee2/image.png",
    remoteImage: "https://images.credly.com/badges/7cb543db-7b58-4711-8ac9-515e5b0caee2/image.png",
    verificationUrl: "https://www.credly.com/badges/7cb543db-7b58-4711-8ac9-515e5b0caee2",
    embedUrl: "https://www.credly.com/embedded_badge/7cb543db-7b58-4711-8ac9-515e5b0caee2",
    description: "Processing complex documents (PDFs, images, diagrams) using Gemini Multimodal reasoning and building Multimodal Retrieval-Augmented Generation pipelines.",
    skills: ["Multimodal RAG", "Gemini 1.5", "Document Processing", "Vector Embeddings", "Vertex AI"],
    issueDate: "2025"
  },
  {
    id: "gcp-app-dev-environment",
    badgeId: "4a90b8af-d538-425d-8113-caf41b4411cd",
    title: "Set Up an App Dev Environment on Google Cloud Skill Badge",
    issuer: "Google Cloud",
    issuerCode: "google",
    category: "cloud",
    categoryLabel: "CLOUD DEVELOPMENT",
    localImage: "https://images.credly.com/badges/4a90b8af-d538-425d-8113-caf41b4411cd/image.png",
    remoteImage: "https://images.credly.com/badges/4a90b8af-d538-425d-8113-caf41b4411cd/image.png",
    verificationUrl: "https://www.credly.com/badges/4a90b8af-d538-425d-8113-caf41b4411cd",
    embedUrl: "https://www.credly.com/embedded_badge/4a90b8af-d538-425d-8113-caf41b4411cd",
    description: "Setting up, configuring, and securing development environments, Cloud Shell, Cloud Storage, and compute resources across Google Cloud projects.",
    skills: ["Cloud SDK", "Google Cloud Shell", "Cloud Storage", "Compute Engine", "IAM Roles"],
    issueDate: "2025"
  },
  {
    id: "gcp-cloud-network",
    badgeId: "f311cc30-4317-4fc2-b07c-23bd76fd9916",
    title: "Develop Your Google Cloud Network Skill Badge",
    issuer: "Google Cloud",
    issuerCode: "google",
    category: "network",
    categoryLabel: "CLOUD NETWORKING",
    localImage: "https://images.credly.com/badges/f311cc30-4317-4fc2-b07c-23bd76fd9916/image.png",
    remoteImage: "https://images.credly.com/badges/f311cc30-4317-4fc2-b07c-23bd76fd9916/image.png",
    verificationUrl: "https://www.credly.com/badges/f311cc30-4317-4fc2-b07c-23bd76fd9916",
    embedUrl: "https://www.credly.com/embedded_badge/f311cc30-4317-4fc2-b07c-23bd76fd9916",
    description: "Architecting and implementing secure VPC networks, subnets, firewall rules, and custom routes across Google Cloud infrastructure.",
    skills: ["VPC Networks", "Cloud Routers", "Firewall Rules", "Network Topology", "GCP Networking"],
    issueDate: "2025"
  },
  {
    id: "gcp-bigquery-insights",
    badgeId: "a66ce229-e4c4-4d25-b234-6505bbfd15c0",
    title: "Derive Insights from BigQuery Data Skill Badge",
    issuer: "Google Cloud",
    issuerCode: "google",
    category: "data",
    categoryLabel: "BIG DATA & WAREHOUSING",
    localImage: "https://images.credly.com/badges/a66ce229-e4c4-4d25-b234-6505bbfd15c0/image.png",
    remoteImage: "https://images.credly.com/badges/a66ce229-e4c4-4d25-b234-6505bbfd15c0/image.png",
    verificationUrl: "https://www.credly.com/badges/a66ce229-e4c4-4d25-b234-6505bbfd15c0",
    embedUrl: "https://www.credly.com/embedded_badge/a66ce229-e4c4-4d25-b234-6505bbfd15c0",
    description: "Writing complex SQL queries, analytical queries, and data extraction pipelines to generate business and technical insights on BigQuery.",
    skills: ["BigQuery", "SQL Analytics", "Data Warehousing", "Data Transformation", "Data Visualization"],
    issueDate: "2025"
  },
  {
    id: "gcp-vertex-ai-gemini",
    badgeId: "c5066686-7b89-4754-ac76-bc8da52d3e63",
    title: "Explore Generative AI with the Vertex AI Gemini API Skill Badge",
    issuer: "Google Cloud",
    issuerCode: "google",
    category: "ai",
    categoryLabel: "GENERATIVE AI & VERTEX",
    localImage: "https://images.credly.com/badges/c5066686-7b89-4754-ac76-bc8da52d3e63/image.png",
    remoteImage: "https://images.credly.com/badges/c5066686-7b89-4754-ac76-bc8da52d3e63/image.png",
    verificationUrl: "https://www.credly.com/badges/c5066686-7b89-4754-ac76-bc8da52d3e63",
    embedUrl: "https://www.credly.com/embedded_badge/c5066686-7b89-4754-ac76-bc8da52d3e63",
    description: "Utilizing Vertex AI Gemini APIs for generative AI workflows, prompt tuning, parameter optimization, and multimodal reasoning.",
    skills: ["Vertex AI", "Gemini API", "Prompt Tuning", "Function Calling", "LLM Evaluation"],
    issueDate: "2025"
  },
  {
    id: "gcp-load-balancing-compute",
    badgeId: "112fc955-e854-4132-859b-89df13abfc75",
    title: "Implement Load Balancing on Compute Engine Skill Badge",
    issuer: "Google Cloud",
    issuerCode: "google",
    category: "cloud",
    categoryLabel: "COMPUTE & LOAD BALANCING",
    localImage: "https://images.credly.com/badges/112fc955-e854-4132-859b-89df13abfc75/image.png",
    remoteImage: "https://images.credly.com/badges/112fc955-e854-4132-859b-89df13abfc75/image.png",
    verificationUrl: "https://www.credly.com/badges/112fc955-e854-4132-859b-89df13abfc75",
    embedUrl: "https://www.credly.com/embedded_badge/112fc955-e854-4132-859b-89df13abfc75",
    description: "Setting up HTTP(S) load balancers, managed instance groups, autoscaling policies, and health checks on Compute Engine.",
    skills: ["Compute Engine", "HTTP(S) Load Balancer", "Autoscaling", "Managed Instance Groups", "Health Checks"],
    issueDate: "2025"
  },
  {
    id: "gcp-prompt-design-vertex",
    badgeId: "fd483fe1-e9be-4832-ace4-6636acb7d767",
    title: "Prompt Design in Vertex AI Skill Badge",
    issuer: "Google Cloud",
    issuerCode: "google",
    category: "ai",
    categoryLabel: "PROMPT ENGINEERING",
    localImage: "https://images.credly.com/badges/fd483fe1-e9be-4832-ace4-6636acb7d767/image.png",
    remoteImage: "https://images.credly.com/badges/fd483fe1-e9be-4832-ace4-6636acb7d767/image.png",
    verificationUrl: "https://www.credly.com/badges/fd483fe1-e9be-4832-ace4-6636acb7d767",
    embedUrl: "https://www.credly.com/embedded_badge/fd483fe1-e9be-4832-ace4-6636acb7d767",
    description: "Designing effective prompts, zero-shot/few-shot techniques, and evaluating model response quality in Vertex AI Studio.",
    skills: ["Prompt Engineering", "Vertex AI Studio", "Zero/Few-Shot Learning", "System Prompts", "Model Parameters"],
    issueDate: "2025"
  }
];
