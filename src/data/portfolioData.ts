...
export const I18N_DATA: Record<"en" | "id", Record<string, string>> = {
  en: {
    ...
    "nav.sub.skills.previewMetric": "CUDA â€¢ PYTORCH â€¢ FASTAPI",
    ...
    "nav.sub.resume.previewMetric": "CGPA 3.92 â€¢ DISTINCTION",
    ...
    "hero.hp": "HP: [â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ] 100%",
    ...
    "pillar.2.desc": "Accelerating PyTorch training pipelines by 10Ã— on AWS cloud infrastructure, containerizing with Docker, and serving micro-latency FastAPI endpoints.",
  ...
  id: {
    ...
    "nav.sub.resume.previewMetric": "IPK 3.92 â€¢ CUMLAUDE",
    ...
    "pillar.2.title": "Production-Grade AI & MLOps",
    "pillar.2.desc": "Mempercepat pipeline pelatihan PyTorch hingga 10Ã— pada cloud AWS, kontainerisasi Docker, dan serving micro-latency FastAPI.",
    "pillar.3.title": "Autonomous Agents & Enterprise RAG",
...
export const EDUCATION_DATA: EducationItem = {
  ...
  faculty: "Faculty of Information Technology â€¢ Jakarta, Indonesia",
  gpa: "3.92 / 4.00",
  thesis: {
