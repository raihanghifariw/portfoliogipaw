...
import { Github, Twitter, Youtube, Linkedin, Instagram } from "@/components/ui/social-icons";
...
export function ProfileCard(props: ProfileCardProps) {
  const {
    ...
    description = "Raihan Ghifari Winata is an AI Engineer graduating with Highest Distinction (CGPA 3.92/4.00) from Universitas Yarsi. Specialized in safety-constrained Deep Reinforcement Learning for healthcare ICU dosage recommendation (75.31% survival rate on MIMIC-III), edge-quantized Vision-Language Models, and high-throughput MLOps.",
    imageUrl = "/about/raihan-profile.webp",
    githubUrl = "#",
    twitterUrl = "#",
    youtubeUrl = "#",
    linkedinUrl = "#",
